...
exports.createTask = exports.getProjects = exports.getWorkspaces = void 0;
const Asana = require("asana");
const constants_1 = require("../constants");
let client = Asana.ApiClient.instance;
let token = client.authentications["token"];
token.accessToken = constants_1.config.asana.token;
...
const createTask = (body, opts = {}) => {
    return tasksApiInstance.createTask(body, opts).then((result) => {
        // console.log("API called successfully. Returned data: " + JSON.stringify(result.data, null, 2));
        return result.data;
    }, (error) => {
